# node-@f1stnpm2/doloribus-quis-quia [![NPM version][npm-img]][npm-url]

[npm-img]: https://img.shields.io/npm/v/@f1stnpm2/doloribus-quis-quia.svg
[npm-url]: https://npmjs.org/package/@f1stnpm2/doloribus-quis-quia

This project provides bindings for [RE2](https://github.com/google/@f1stnpm2/doloribus-quis-quia):
...
(see [Syntax](https://github.com/google/@f1stnpm2/doloribus-quis-quia/wiki/Syntax)),
...
All documentation can be found in this README and in the [wiki](https://github.com/f1stnpm2/doloribus-quis-quia/wiki).

## Why use node-@f1stnpm2/doloribus-quis-quia?
...
node-@f1stnpm2/doloribus-quis-quia can protect your Node.js application from ReDoS.
node-@f1stnpm2/doloribus-quis-quia makes vulnerable regular expression patterns safe by evaluating them in `RE2` instead of the built-in Node.js regex engine.
...
* [`@f1stnpm2/doloribus-quis-quia.lastIndex`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/lastIndex)
* [`@f1stnpm2/doloribus-quis-quia.global`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/global)
* [`@f1stnpm2/doloribus-quis-quia.ignoreCase`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/ignoreCase)
* [`@f1stnpm2/doloribus-quis-quia.multiline`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/multiline)
* [`@f1stnpm2/doloribus-quis-quia.dotAll`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/dotAll) &mdash; *since 1.17.6.*
* [`@f1stnpm2/doloribus-quis-quia.unicode`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/unicode)
  * `RE2` engine always works in the Unicode mode. See details below.
* [`@f1stnpm2/doloribus-quis-quia.sticky`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/sticky) &mdash; *since 1.7.0.*
* [`@f1stnpm2/doloribus-quis-quia.hasIndices`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/hasIndices) &mdash; *since 1.19.0.*
* [`@f1stnpm2/doloribus-quis-quia.source`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/source)
* [`@f1stnpm2/doloribus-quis-quia.flags`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/flags)

Supported methods:

* [`@f1stnpm2/doloribus-quis-quia.exec(str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/exec)
* [`@f1stnpm2/doloribus-quis-quia.test(str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/test)
* [`@f1stnpm2/doloribus-quis-quia.toString()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/toString)
...
* [`@f1stnpm2/doloribus-quis-quia[Symbol.match](str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/match)
* [`@f1stnpm2/doloribus-quis-quia[Symbol.matchAll](str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/matchAll) &mdash; *since 1.17.5.*
* [`@f1stnpm2/doloribus-quis-quia[Symbol.search](str)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/search)
* [`@f1stnpm2/doloribus-quis-quia[Symbol.replace](str, newSubStr|function)`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/replace)
* [`@f1stnpm2/doloribus-quis-quia[Symbol.split](str[, limit])`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Symbol/split)
...
var @f1stnpm2/doloribus-quis-quia = new RE2(re1);     // from another RE2 object
```
...
* `@f1stnpm2/doloribus-quis-quia.exec(buf)`
* `@f1stnpm2/doloribus-quis-quia.test(buf)`
* `@f1stnpm2/doloribus-quis-quia.match(buf)`
* `@f1stnpm2/doloribus-quis-quia.search(buf)`
* `@f1stnpm2/doloribus-quis-quia.split(buf[, limit])`
* `@f1stnpm2/doloribus-quis-quia.replace(buf, replacer)`
...
When `@f1stnpm2/doloribus-quis-quia.replace()` is used with a replacer function, the replacer can return a buffer, or a string. But all arguments
...
```
npm install --save @f1stnpm2/doloribus-quis-quia
```
...
(see this [Wiki article](https://github.com/f1stnpm2/doloribus-quis-quia/wiki/Problem:-unusual-errors-with-yarn)).

### Precompiled artifacts

When installing @f1stnpm2/doloribus-quis-quia the [install script](https://github.com/uhop/install-artifact-from-github/blob/master/bin/install-from-cache.js) attempts to download a prebuilt artifact for your system from the Github releases. The download location can be overridden by setting the `RE2_DOWNLOAD_MIRROR` environment variable as seen in the install script.

If all attempts to download the prebuilt artifact for your system fails the script attempts to built @f1stnpm2/doloribus-quis-quia locally on your machine using [node-gyp](https://github.com/nodejs/node-gyp).
...
```js
var RE2 = require("@f1stnpm2/doloribus-quis-quia");
...
var @f1stnpm2/doloribus-quis-quia = new RE2(pattern);

var input = 'abc';

var bi_res = built_in.exec(input);
var @f1stnpm2/doloribus-quis-quia_res = @f1stnpm2/doloribus-quis-quia.exec(input);

console.log('bi_res: ' + bi_res);    // prints: bi_res: abc,,,c
console.log('@f1stnpm2/doloribus-quis-quia_res : ' + @f1stnpm2/doloribus-quis-quia_res); // prints: @f1stnpm2/doloribus-quis-quia_res : abc,a,b,c
```
...
The rest can be consulted in the project's wiki [Release history](https://github.com/f1stnpm2/doloribus-quis-quia/wiki/Release-history).
